...
<div className='bg-white flex justify-center items-center'>
  ...
  <select
    ...
    required
    className='outline-none w-full text-black px-1 pr-3 py-2 bg-white'
  >
    <option value=''>Select Company</option>
    <option value='1'>AAiT</option>
    <option value='2'>CBE</option>
    <option value='3'>Ethiotelecom</option>
    {/* Add more companies or map from backend */}
  </select>
</div>
